...
const REGIMENS = {
  ...
  polaRChp: {
    id: "polaRChp",
    name: "Pola-R-CHP療法",
    subtitle: "Polatuzumab vedotin + Rituximab + Cyclophosphamide + Doxorubicin + Prednisone",
    dayHints: [
      { min: 1, max: 3, text: "day 1-3 は輸注関連反応、発熱、悪心 / 嘔吐、腫瘍崩壊症候群、輸液部位異常を意識して確認。" },
      { min: 4, max: 7, text: "day 4-7 は下痢、便秘、口腔粘膜炎、食欲低下、血尿 / 排尿時痛、末梢神経症状の出現を確認。" },
      { min: 8, max: 14, text: "day 8-14 は好中球減少、発熱性好中球減少症、感染症、貧血症状、肝障害を優先確認。" },
      { min: 15, max: 21, text: "day 15-21 は骨髄抑制の遷延、感染症、しびれの遷延、心不全症状、HBV関連肝障害を確認。" },
      { min: 22, max: 99, text: "後半や治療後は末梢神経障害、HBV再活性化、PMLを示唆する神経症状、遅発性心機能低下を継続確認。" },
    ],
    adverseSections: [
      {
        title: "重篤な副作用",
        tone: "danger",
        items: [
          { title: "重度感染症 / 肺炎 / 敗血症", marker: "最優先", note: "POLARIX では grade 5 事象の多くが感染関連で、肺炎と敗血症が主要因だった。発熱、咳、SpO2低下、血圧低下を優先確認する。" },
          { title: "発熱性好中球減少症 / 高度好中球減少", marker: "要介入", note: "POLARIX では grade 3-4 好中球減少 28.3%、発熱性好中球減少症 13.8%。G-CSF 併用下でも重要な安全性項目。" },
          { title: "輸注関連反応", marker: "day 1重要", note: "POLIVY と rituximab の両方で警告。初回投与時は発熱、悪寒、呼吸器症状、血行動態変化に注意する。" },
          { title: "腫瘍崩壊症候群", marker: "導入初期", note: "POLIVY と RITUXAN の警告事項。高腫瘍量では尿酸、K、P、Ca、Cr の変化と不整脈、乏尿を見逃さない。" },
          { title: "B型肝炎再活性化 / 重度肝障害", marker: "遅発も注意", note: "RITUXAN は boxed warning として HBV 再活性化を持ち、POLIVY でも hepatotoxicity が警告される。AST / ALT、ビリルビン、倦怠感、黄疸を追う。" },
          { title: "PMLを示唆する神経症状", marker: "まれだが重篤", note: "POLIVY と RITUXAN の両方で PML が警告される。新規の認知変化、失語、麻痺、けいれんは緊急評価を要する。" },
          { title: "心機能低下 / 不整脈", marker: "アントラサイクリン注意", note: "doxorubicin は累積用量依存の cardiomyopathy と遅発性心不全があり、rituximab でも cardiac adverse reactions が警告される。" },
        ],
      },
      {
        title: "頻度の高い副作用",
        tone: "warn",
        items: [
          { title: "末梢神経障害", marker: "53%", note: "POLARIX で any-grade 52.9%。多くは grade 1 だが、しびれの遷延は次コース判断に影響する。" },
          { title: "悪心", marker: "42%", note: "POLARIX で any-grade 41.6%。脱水や経口摂取低下につながるため確認する。" },
          { title: "下痢", marker: "31%", note: "POLARIX で any-grade 30.8%。脱水や栄養低下の原因になりうる。" },
          { title: "便秘", marker: "29%", note: "POLARIX で any-grade 28.7%。化学療法支持療法や活動性低下も含めて把握する。" },
          { title: "貧血", marker: "29% / G3-4 12%", note: "POLARIX で any-grade 28.7%、grade 3-4 12.0%。息切れや倦怠感の背景として確認する。" },
          { title: "疲労", marker: "26%", note: "POLARIX で any-grade 25.7%。感染、貧血、心機能低下の前景症状でないか併せて判断する。" },
          { title: "口腔粘膜炎", marker: "20%以上", note: "POLIVY の R-CHP 併用で 20%以上の主要有害事象。摂食低下や感染リスクに影響する。" },
          { title: "食欲低下", marker: "16%", note: "POLARIX で any-grade 16.3%。体重減少や脱水と合わせて見る。" },
          { title: "発熱", marker: "16%", note: "POLARIX で any-grade 15.6%。感染症、FN、輸注関連反応との切り分けが必要。" },
        ],
      },
      {
        title: "特徴的な副作用",
        tone: "info",
        items: [
          { title: "末梢神経障害", marker: "Polaらしさ", note: "vincristine を外しても pola-R-CHP で神経毒性は残る。POLIVY の用量調整対象として重要。" },
          { title: "輸注関連反応", marker: "抗体 / ADC", note: "rituximab と polatuzumab の両方が関与する投与日重視の毒性。" },
          { title: "血尿 / 出血性膀胱炎", marker: "CPAらしさ", note: "cyclophosphamide 由来の easy-to-miss toxicity。肉眼的血尿、排尿時痛、頻尿を確認する。" },
          { title: "遅発性心機能低下", marker: "DXRらしさ", note: "doxorubicin は治療中だけでなく治療後数年で cardiomyopathy が顕在化しうる。" },
          { title: "HBV再活性化", marker: "rituximab注意", note: "抗CD20 治療では遅発性でも重篤化しうるため、肝炎症状と肝機能異常を継続確認する。" },
          { title: "PMLを示唆する神経症状", marker: "抗CD20 / Pola", note: "頻度は低いが、認知・行動・局在神経症状の新規出現は見逃さない。" },
        ],
      },
    ],
    symptoms: [
  ...
  cpx351: {
    id: "cpx351",
    name: "CPX-351療法",
    subtitle: "Liposomal daunorubicin + cytarabine for secondary AML / AML-MRC",
    dayHints: [
      { min: 1, max: 5, text: "day 1-5 は induction の投与日。悪心 / 嘔吐、発疹、頭痛、過敏反応、血管外漏出に注意しながら開始する。" },
      { min: 6, max: 14, text: "day 6-14 は口腔粘膜炎、下痢、便秘、食欲低下、疲労が出やすい。血球減少の進行も意識して確認。" },
      { min: 15, max: 28, text: "day 15-28 は好中球減少、発熱性好中球減少症、感染症、肺炎、出血、呼吸苦を最優先で確認。" },
      { min: 29, max: 42, text: "day 29-42 は好中球 / 血小板回復が遅れやすい。遷延する感染症、出血、倦怠感、心症状の持続を確認。" },
      { min: 43, max: 99, text: "day 43以降は回復遅延がないか確認し、consolidation なら day 1 / 3 投与を前提に CBC、肝腎機能、心機能を再評価する。" },
    ],
    adverseSections: [
      {
        title: "重篤な副作用",
        tone: "danger",
        items: [
          { title: "発熱性好中球減少症", marker: "最優先", note: "phase 3 試験で grade 3-5 が 68.0%。AML導入で最も見逃したくない緊急毒性。" },
          { title: "重度感染症 / 肺炎 / 菌血症", marker: "要介入", note: "USPI では serious adverse reactions として dyspnea、sepsis、pneumonia、bacteremia が並ぶ。発熱、咳、呼吸苦、血圧低下を優先確認する。" },
          { title: "出血", marker: "要介入", note: "USPI の最頻出AEの一つで、原著では bleeding event が any-grade 74.5%。血小板回復遅延を背景に重篤化しうる。" },
          { title: "心機能低下 / 不整脈", marker: "アントラサイクリン", note: "USPI で cardiotoxicity と arrhythmia が強調される。息切れ、浮腫、動悸、胸部症状があれば早めに評価する。" },
          { title: "呼吸不全シグナル", marker: "見逃し注意", note: "原著では grade 3-5 hypoxia が 13.1%。肺炎や循環不全の初期像として呼吸苦、SpO2低下を追う。" },
        ],
      },
      {
        title: "頻度の高い副作用",
        tone: "warn",
        items: [
          { title: "好中球減少 / 血小板減少 / 貧血", marker: "回復遅延", note: "原著では好中球 / 血小板回復が 7+3 より遅い。CBC を継続確認し、次段階治療判断にも反映する。" },
          { title: "悪心 / 嘔吐", marker: "25%以上", note: "USPI で common AE。脱水や経口摂取低下につながるため早期から確認する。" },
          { title: "下痢 / 便秘", marker: "25%以上", note: "USPI で common AE。便通回数、腹痛、脱水の有無を確認する。" },
          { title: "口腔粘膜炎", marker: "25%以上", note: "USPI と cytarabine component review で支持される。食事摂取低下や感染リスクに直結する。" },
          { title: "疲労 / 食欲低下", marker: "25%以上", note: "全身状態低下の把握に有用で、感染症や貧血の前景症状でないか併せて判断する。" },
          { title: "発疹", marker: "25%以上", note: "USPI の common AE。軽症に見えても範囲拡大や掻痒、粘膜症状を伴う場合は重症度を見直す。" },
        ],
      },
      {
        title: "特徴的な副作用",
        tone: "info",
        items: [
          { title: "血球回復の遅延", marker: "CPX-351らしさ", note: "原著では responders の好中球 / 血小板回復がやや遅い。day 15 以降も marrow nadir を長めに意識する。" },
          { title: "心毒性", marker: "daunorubicin由来", note: "心不全、心筋障害、不整脈を component-drug review で確認。overview でも必ず意識する。" },
          { title: "粘膜障害 / GI毒性", marker: "cytarabine由来", note: "口腔粘膜炎、下痢、腹痛は bedside review の実用性が高い。" },
          { title: "血管外漏出時の局所障害", marker: "投与時注意", note: "daunorubicin component review では extravasation による局所壊死が明記される。投与ライン異常は早めに拾う。" },
        ],
      },
    ],
    symptoms: [
  ...
  epkinly: {
    id: "epkinly",
    name: "エプキンリ療法",
    subtitle: "Epcoritamab monotherapy for R/R LBCL",
    dayHints: [
      { min: 1, max: 3, text: "day 1-3 は特に cycle 1 で step-up dose 1 近傍の発熱、悪寒、注射部位反応、早期 CRS 徴候を確認。" },
      { min: 4, max: 7, text: "day 4-7 は持続する発熱、感染徴候、発疹、下痢、頭痛がないかを確認。" },
      { min: 8, max: 14, text: "day 8-14 は step-up dose 2 後と first full dose 前後を意識し、CRS / ICANS、呼吸器症状、血圧低下を見逃さない。" },
      { min: 15, max: 21, text: "day 15-21 は特に cycle 1 day 15 の first full dose 近傍で CRS、神経症状、発熱、感染症、K / Ca / 尿酸 / Cr 変化を優先確認。" },
      { min: 22, max: 99, text: "day 22以降は感染症、好中球減少 / 貧血 / 血小板減少、疲労、発疹、遅発神経症状の持続を確認。" },
    ],
    adverseSections: [
      {
        title: "重篤な副作用",
        tone: "danger",
        items: [
          { title: "サイトカイン放出症候群（CRS）", marker: "最優先", note: "boxed warning レベルの中心毒性。global EPCORE NHL-1 で約 50%、日本人 DLBCL では 83.3%。特に cycle 1 day 15 の first full dose 後に優先して評価する。" },
          { title: "神経系事象（ICANS）", marker: "見逃し注意", note: "boxed warning レベル。頻度は高くないが見逃したくない。錯乱、失語、書字障害、傾眠、頭痛、意識変容を確認する。" },
          { title: "重度感染症", marker: "要介入", note: "2-year follow-up では grade 3-4 infection が 25.5%。発熱、咳、呼吸苦、咽頭痛、局所症状があれば早めに評価する。" },
          { title: "高度好中球減少 / 血球減少", marker: "要介入", note: "global trial で neutropenia 21.7-23.6%、日本人 DLBCL では 38.9%。感染症や治療継続判断のトリガーとして重要。" },
          { title: "腫瘍崩壊症候群", marker: "まれでも重篤", note: "clinical TLS は 1.3% と少ないが、K / P / Ca / 尿酸 / Cr の変化や乏尿、不整脈を見逃さない。" },
        ],
      },
      {
        title: "頻度の高い副作用",
        tone: "warn",
        items: [
          { title: "発熱", marker: "23-25%", note: "CRS と感染症の切り分け起点になるため、単独でも軽視しない。" },
          { title: "疲労", marker: "24-25%", note: "倦怠感は CRS、感染症、貧血の前景症状でないか併せて判断する。" },
          { title: "好中球減少 / 貧血 / 血小板減少", marker: "血球減少", note: "好中球減少に加え、Hb 低下や血小板減少も比較的目立つ。CBC を継続確認する。" },
          { title: "悪心 / 下痢 / 食欲低下", marker: "症候確認", note: "脱水や全身状態低下につながるため、回数や経口摂取低下の程度を確認する。" },
          { title: "発疹 / 皮膚症状", marker: "日本人で19.4%", note: "rash は DailyMed の common AE にも含まれる。範囲拡大や疼痛、発熱合併があれば重症度を見直す。" },
        ],
      },
      {
        title: "特徴的な副作用",
        tone: "info",
        items: [
          { title: "cycle 1 step-up dosing後の CRS", marker: "day 15重要", note: "step-up dosing を使っても first full dose 後の CRS 監視は重要。monitoring priority を day hint に反映する。" },
          { title: "注射部位反応", marker: "皮下注ならでは", note: "日本人 DLBCL では 69.4%。紅斑、腫脹、疼痛、そう痒を確認し、見た目以上の局所炎症がないかみる。" },
          { title: "発疹 / 皮膚症状", marker: "drugらしさ", note: "注射部位反応とは別に全身性の発疹もありうる。皮膚所見は overview でも意識する。" },
          { title: "治療初期 12週以内に AE が集まりやすい", marker: "early phase", note: "JCO 2023 では多くの treatment-related AE が最初の 12 週に集中していた。序盤は監視密度を高める。" },
        ],
      },
    ],
    symptoms: [
      ...
      { id: "diarrhea", name: "下痢", tag: "頻用", grades: { 1: "ベースラインより < 4 回/日の増加。", 2: "ベースラインより 4 〜 6 回/日の増加。", 3: "ベースラインより >= 7 回/日の増加、失禁、入院、高度脱水。", 4: "生命を脅かす。", 5: "死亡。" } },
      { id: "rash", name: "斑状丘疹状皮疹", tag: "特徴的", grades: { 1: "限局性。", 2: "範囲が広がる / 症候を伴う。", 3: "広範囲で ADL に影響し、全身治療を要する。", 4: "生命を脅かす重度皮膚障害。", 5: "死亡。" } },
      { id: "injection-site-reaction", name: "注射部位反応", tag: "特徴的", checklist: "紅斑、腫脹、疼痛、硬結、熱感、そう痒、水疱、びらん", grades: { 1: "軽度の局所紅斑、腫脹、疼痛、またはそう痒。", 2: "局所処置、外用薬、鎮痛薬、または診察を要する。", 3: "高度の疼痛、潰瘍、水疱、感染疑い、または明確な医学的介入を要する。", 4: "広範な壊死や重篤な局所組織障害で緊急対応を要する。", 5: "死亡。" } },
      { id: "tumor-lysis", name: "腫瘍崩壊症候群", tag: "重篤", checklist: "K上昇、P上昇、Ca低下、尿酸上昇、Cr上昇、不整脈、乏尿", grades: { 1: "-", 2: "臨床的または検査上の異常を認め、慎重な評価を要する。", 3: "入院または明確な医学的介入を要する。", 4: "生命を脅かす。緊急対応を要する。", 5: "死亡。" } },
    ],
    labs: [
      { id: "wbc", label: "白血球数減少", shortLabel: "WBC", unit: "/μL", grades: LAB_DEFINITIONS.wbc },
  ...
  mel200MmAsct: {
    id: "mel200MmAsct",
    name: "MEL200（MM自家移植）",
    subtitle: "High-dose melphalan 200 mg/m2 before autologous SCT",
    dayHints: [
      { min: 1, max: 3, text: "day 1-3 は悪心 / 嘔吐、投与近接のアレルギー / 呼吸器症状、補液後の尿量低下がないかを確認。" },
      { min: 4, max: 7, text: "day 4-7 は口腔粘膜炎、下痢、脱水、持続する発熱、肝腎機能悪化を意識して確認。" },
      { min: 8, max: 14, text: "day 8-14 は好中球減少、発熱性好中球減少症、感染症、血小板減少 / 出血を最優先で確認。" },
      { min: 15, max: 28, text: "後半は骨髄回復遅延、感染症の遷延、肝障害 / VOD、腎機能低下、呼吸器 / 心症状の持続を確認。" },
    ],
    adverseSections: [
      {
        title: "重篤な副作用",
        tone: "danger",
        items: [
          { title: "発熱性好中球減少症 / 重度感染症", marker: "最優先", note: "メルファラン後の深い骨髄抑制により致命的な感染症がありうる。発熱、悪寒、咳、局所症状を最優先で評価する。" },
          { title: "高度好中球減少", marker: "要介入", note: "移植前処置として深い骨髄抑制が前提となるため、ANC低下は感染症トリガーとして最重要。" },
          { title: "高度血小板減少 / 出血", marker: "要介入", note: "致命的な出血リスクがある。皮下出血、歯肉出血、血尿、黒色便を確認する。" },
          { title: "ショック / アナフィラキシー", marker: "投与近接", note: "PMDA と DailyMed で重篤な過敏反応が警告される。投与近接の呼吸苦、低血圧、蕁麻疹に注意する。" },
          { title: "重篤な肝障害 / 肝中心静脈閉塞症", marker: "見逃し注意", note: "AST / ALTやビリルビン上昇に加えて、急な体重増加、右季肋部痛、肝腫大、黄疸があれば VOD を疑う。" },
          { title: "間質性肺炎 / 呼吸不全", marker: "見逃し注意", note: "まれでも重篤化しうるため、新規の呼吸苦、低酸素、咳を見逃さない。" },
        ],
      },
      {
        title: "頻度の高い副作用",
        tone: "warn",
        items: [
          { title: "悪心 / 嘔吐", marker: "63.4%", note: "PMDA で高頻度。経口摂取低下や脱水につながるため早期から確認する。" },
          { title: "下痢", marker: "92.7%", note: "PMDA で dose-limiting toxicity として強調される。回数増加、血便、脱水を確認する。" },
          { title: "口内炎 / 口腔粘膜炎", marker: "80.5%", note: "下痢と並ぶ主要な dose-limiting toxicity。疼痛と経口摂取低下の程度を追う。" },
          { title: "AST / ALT上昇", marker: "51.2%", note: "肝障害は比較的よくみられ、VOD の前景所見になりうる。" },
          { title: "白血球 / 好中球減少", marker: "骨髄抑制", note: "MEL200 の中心的毒性で、感染症評価とセットでみる。" },
          { title: "血小板減少", marker: "骨髄抑制", note: "輸血判断や出血症状の確認に直結する。" },
        ],
      },
      {
        title: "特徴的な副作用",
        tone: "info",
        items: [
          { title: "粘膜障害が dose-limiting", marker: "MEL200らしさ", note: "PMDA で下痢と口内炎が用量規制因子として明示される。overview でも意識する。" },
          { title: "深い骨髄抑制と支持療法前提", marker: "移植前処置", note: "感染予防、輸血、造血因子投与など支持療法を前提とするレジメンであることを忘れない。" },
          { title: "腎機能悪化 / 乏尿", marker: "補液・利尿管理", note: "補液や利尿管理とセットでみるべき毒性。Cr 上昇や尿量低下があれば早めに拾う。" },
          { title: "心機能障害 / 不整脈", marker: "前治療歴注意", note: "前治療の心毒性薬歴がある患者では特に見逃したくない。" },
        ],
      },
    ],
    symptoms: [
      { id: "febrile-neutropenia", name: "発熱性好中球減少症", tag: "重篤", checklist: "発熱、ANC低下、悪寒、血圧低下、呼吸器症状、局所感染徴候", grades: { 1: "-", 2: "慎重な評価を要する。", 3: "速やかな医学的評価または治療介入を要する。", 4: "生命を脅かす感染症や血行動態不安定を伴い、緊急対応を要する。", 5: "死亡。" } },
      { id: "infusion-reaction", name: "輸注関連反応", tag: "重篤", grades: { 1: "軽度。", 2: "治療または投与中断を要する。速やかに改善しうる。", 3: "遷延または再発しうる高度の症状で、入院または明確な医学的介入を要する。", 4: "生命を脅かす。緊急対応を要する。", 5: "死亡。" } },
      { id: "infection", name: "感染症", tag: "重篤", checklist: "発熱、悪寒、咳、呼吸苦、咽頭痛、局所疼痛 / 発赤、血圧低下", grades: { 1: "軽度。局所症状のみ。", 2: "局所治療または内服治療を要する。", 3: "静注治療、侵襲的処置、または入院を要する。", 4: "生命を脅かす感染症。緊急対応を要する。", 5: "死亡。" } },
      { id: "fever", name: "発熱", tag: "頻用", grades: { 1: "38.0 ℃以上 39.0 ℃未満。", 2: "39.0 ℃以上 40.0 ℃未満。", 3: "40.0 ℃以上 > 24 時間、または入院相当の評価・介入を要する。", 4: "生命を脅かす全身状態悪化を伴う。", 5: "死亡。" } },
      { id: "nausea", name: "悪心", tag: "頻用", grades: { 1: "食欲低下を伴うが、食事量低下は軽度。", 2: "経口摂取量が明らかに低下する。", 3: "カロリー / 水分補給に医療的介入を要する。", 4: "-", 5: "死亡。" } },
      { id: "vomiting", name: "嘔吐", tag: "頻用", grades: { 1: "24 時間に 1 〜 2 回。", 2: "24 時間に 3 〜 5 回。", 3: "24 時間に 6 回以上、または点滴 / TPN / 入院を要する。", 4: "生命を脅かす。", 5: "死亡。" } },
